...
from new_deductive_1d_game.version3.game_core import MurderGame, MurderParams
from open_spiel.python import rl_environment
from new_deductive_1d_game.version3.agents import ISMCTSAgent, RandomAgent, OptimalAgent,BetterRandomAgent
